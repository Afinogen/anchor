        ...
        <div className="flex items-center gap-2">
            ...
            >
              {isSaving ? (
                <>
                  ...
                  <span>{t("notes.editor.saving")}</span>
                </>
              ) : hasUnsavedChanges ? (
                <>
                  <div className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse" />
                  <span>{t("notes.editor.unsaved")}</span>
                </>
              ) : isSaved ? (
                <>
                  <Check className="h-3 w-3" />
                  <span>{t("notes.editor.saved")}</span>
                </>
              ) : null}
            </div>
          )}
          ...
          {!isReadOnly && (
            <>
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom">
                  {isPinned
                    ? t("notes.editor.unpinNote")
                    : t("notes.editor.pinNote")}
                </TooltipContent>
              </Tooltip>
            </>
          )}
          ...
          {!isNew && onHistoryClick && (
            <Tooltip>
              ...
              <TooltipContent side="bottom">
                {t("notes.history.versionHistory")}
              </TooltipContent>
            </Tooltip>
          )}
          ...
          {!isNew && isOwner && !isTrashed && onShareClick && (
            <Tooltip>
              ...
              <TooltipContent side="bottom">
                {hasShares
                  ? t("notes.editor.manageShares")
                  : t("notes.editor.shareNote")}
              </TooltipContent>
            </Tooltip>
          )}
                ...
                {isOwner && (
                  <>
                    <Tooltip>
                      ...
                      <TooltipContent side="bottom">
                        {isArchived
                          ? t("notes.editor.unarchiveNote")
                          : t("notes.editor.archiveNote")}
                      </TooltipContent>
                    </Tooltip>
